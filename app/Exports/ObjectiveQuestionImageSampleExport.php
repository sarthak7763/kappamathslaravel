...
class ObjectiveQuestionImageSampleExport implements FromArray, WithMultipleSheets
{
    ...
    {
        $sheets = [
            new ObjectiveQuizQuestionsImageSampleExport($this->questionarray,$this->quizid_arr),
            new ObjectiveQuizTopicsExport($this->quiz_topic_arr),
        ];
