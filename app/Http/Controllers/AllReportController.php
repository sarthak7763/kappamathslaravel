...
class AllReportController extends Controller
{
    public function index(Request $request)
    {
    	if(count($request->all()) > 0)
    	{
    		...
    		{
    			if($request->filter_result_date[0]!="" && $request->filter_result_date[1]!="")
    			{
    				...
    				$resultmarksdata=Resultmarks::where('user_id',$request->filter_user)->where('result_marks_date','>=',$filter_start_date)->where('result_marks_date','<=',$filter_end_date)->orderBy('result_marks_date','desc')->get();

    			}
    			elseif($request->filter_result_date[0]!="" && $request->filter_result_date[1]=="")
    			{
    				$filter_user=$request->filter_user;
    				$filter_end_date="";
    				$filter_start_date=date('Y-m-d',strtotime($request->filter_result_date[0]));

    				$resultmarksdata=Resultmarks::where('user_id',$request->filter_user)->where('result_marks_date','>=',$filter_start_date)->orderBy('result_marks_date','desc')->get();
    			}
    			elseif($request->filter_result_date[0]=="" && $request->filter_result_date[1]!="")
    			{
    				$filter_user=$request->filter_user;
    				...
    				$resultmarksdata=Resultmarks::where('user_id',$request->filter_user)->where('result_marks_date','<=',$filter_end_date)->orderBy('result_marks_date','desc')->get();
    			}
    			else{
    				$filter_user=$request->filter_user;
    				$filter_start_date="";
    		...
    		elseif(!empty(array_filter($request->filter_result_date)) && $request->filter_user=="")
    		{
    			if($request->filter_result_date[0]!="" && $request->filter_result_date[1]!="")
    			{
    				...
    				$resultmarksdata=Resultmarks::where('result_marks_date','>=',$filter_start_date)->where('result_marks_date','<=',$filter_end_date)->orderBy('result_marks_date','desc')->get();
    			...
    			elseif($request->filter_result_date[0]!="" && $request->filter_result_date[1]=="")
    			{
    				...
    				$resultmarksdata=Resultmarks::where('result_marks_date','>=',$filter_start_date)->orderBy('result_marks_date','desc')->get();
    			}
    			elseif($request->filter_result_date[0]=="" && $request->filter_result_date[1]!="")
    			{
    				$filter_user="";
    				...
    				$resultmarksdata=Resultmarks::where('result_marks_date','<=',$filter_end_date)->orderBy('result_marks_date','desc')->get();
    			}
    			else{
    				$filter_user="";
    				$filter_start_date="";
        ...
        return view('admin.all_reports.index',compact('result_data','usernamelist','filter_user','filter_start_date','filter_end_date'));
    }
