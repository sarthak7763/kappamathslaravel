...
class AllReportController extends Controller
{
    ...
    {   
        ...
        $answers =  Answer::where('topic_id','=',$id)->where('user_id',$userid)->get();
        return $pdf = PDF::loadView('admin.all_reports.report', compact('answers','topic','user'));
        return $pdf->download("$user->name's report.pdf");
        // return view('admin.all_reports.report',compact('answers','topic','user'));
    }
    /**
