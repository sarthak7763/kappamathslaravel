...
@if (session()->has('success'))
  ...
  <div class="margin-bottom">
    <a href="{{route('objective-excel-instructions.create')}}" data-toggle="tooltip" data-original-title="Edit" class="btn btn-primary btn-floating">Add Instruction</a>
  </div>
  ...
  <div class="box">
    ...
    <div class="box-body table-responsive">
      <table id="coursetopicTable" class="table table-hover table-striped">
        ...
        @if(isset($objectiveexcelinsdata))
        <tbody>
...
$(function () {
    var table = $('#coursetopicTable').DataTable({
      ...
      ajax: "{{ route('objective-excel-instructions.index') }}",
      columns: [
